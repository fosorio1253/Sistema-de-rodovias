...
namespace DER.WebApp.Domain.Business
{
    public class AssuntosBLL
    {
        ...
        private AssuntoViewModel ConvertModel(List<DadoMestreTabelaValoresViewModel> lmodel)
        {
            try
            {
                return new AssuntoViewModel()
                {
                    assunto_id = Convert.ToInt32(lmodel.Where(y => y.nome_coluna.Equals("assunto_id")).Select(y => y.valor).FirstOrDefault()),
