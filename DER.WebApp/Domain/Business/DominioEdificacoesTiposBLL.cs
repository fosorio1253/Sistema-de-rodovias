...
namespace DER.WebApp.Domain.Business
{
    public class DominioEdificacoesTiposBLL
    {
        ...
        public DominioEdificacoesTiposBLL()
        {
        ...
        private DominioEdificacoesTiposViewModel ModelToViewModel(DominioEdificacoesTipos model)
        {
            try
            {
            ...
            {
                return new DominioEdificacoesTiposViewModel();
            }
        }
    }
